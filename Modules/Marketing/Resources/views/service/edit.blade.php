    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <x-breadcrumb pageTitle="Layanan">
                <x-slot name="link">
                    <x-breadcrumb.link href="{{ route('adm.marketing.service.index') }}" pageTitle="Layanan" />
                    <x-breadcrumb.link active="true" pageTitle="Edit" />
                </x-slot>

                <x-slot name="button">
                    <x-button.back href="{{ route('adm.marketing.service.index') }}" />
                </x-slot>
            </x-breadcrumb>

            <x-blank-container class="justify-content-center">
                <livewire:marketing::service.edit :service="$service" />
            </x-blank-container>
        </div>
    </div>
@endsection
