...
@section('title', cache('seo.project.title'))

@push('meta')
    <meta name="author" content="{{ cache('app_name') }}" />
    <meta name="description" content="{{ cache('seo.project.description') }}" />
    <meta name="keywords" content="{{ cache('seo.keywords') }}" />

    <!-- SOCIAL MEDIA META -->
    <meta property="og:description" content="{{ cache('seo.project.description') }}" />
    ...
    <meta property="og:title" content="{{ cache('app_name') }} | {{ cache('seo.project.title') }}" />
    ...
    <meta name="twitter:title" content="{{ cache('app_name') }} | {{ cache('seo.project.title') }}" />
    <meta name="twitter:description" content="{{ cache('seo.project.description') }}" />
    <meta name="twitter:image"
          content="{{ cache('default_logo_square') ? url(cache('default_logo_square')) : 'https://via.placeholder.com/600x400/181818/ddd?text=' . cache('app_name') . '.com' }}" />
@endpush

@section('content')
    <x-guest.breadcrumb pageTitle="Proyek">
