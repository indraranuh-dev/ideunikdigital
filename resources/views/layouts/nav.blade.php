<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        @hasanyrole('Developer|Admin|SEO|Editor')
            ...
            <li class="{{ activeRouteIs('adm.marketing.service.*') }}">
                <a href="{{ route('adm.marketing.service.index') }}">
                    <div class="parent-icon"><i class='bx bx-git-branch'></i></div>
                    <div class="menu-title">Layanan</div>
                </a>
            </li>

            <li class="{{ activeRouteIs('adm.marketing.project.*') }}">
                <a href="{{ route('adm.marketing.project.index') }}">
                    <div class="parent-icon"><i class='bx bx-chalkboard'></i></div>
                    <div class="menu-title">Proyek</div>
                </a>
            </li>

            <li class="{{ activeRouteIs('adm.marketing.team.*') }}">
                <a href="{{ route('adm.marketing.team.index') }}">
